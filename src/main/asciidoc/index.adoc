...
operation::create-event[snippets='request-fields,curl-request,http-reqeust, reqeust-headers,http-response,response-headers, response-fields,links']
...
operation::update-event[snippets='request-fields,curl-request,http-request,http-response,links']